                ...
                <div className="row">
                    ...
                    <div className="card card-primary card-tabs">
                        ...
                        <ul className="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                            ...
                            <li className="nav-item">
                            <a className="nav-link active" id="custom-tabs-two-profile-tab" data-toggle="pill" href="#custom-tabs-two-profile" role="tab" aria-controls="custom-tabs-two-profile" aria-selected="false">Roles Menu Mapping</a>
                            </li>
                        ...
                        <div className="tab-content" id="custom-tabs-two-tabContent">
                            ...
                            <div className="tab-pane fade show active" id="custom-tabs-two-profile" role="tabpanel" aria-labelledby="custom-tabs-two-profile-tab">
                                <UserRoleMapping/>
                            </div>
