                            ...
                            <div className="card-header">
                                <div className="card-title">
                                        <div className="input-group input-group-sm">
                                            ...
                                            {/* <Link to="/addDealer"><button type="button" className="btn btn-primary btn-flat" >Create New Dealer &nbsp;&nbsp;<i className="fas fa-plus"></i></button></Link> */}
                                            <button type="button" className="btn btn-primary btn-flat" data-toggle="modal" data-target="#new_dealer">Create New Dealer &nbsp;&nbsp;<i className="fas fa-plus"></i></button>&nbsp;&nbsp;&nbsp;
                                            ...
                                            <form>
                                                    <div className="form-row m-2">
                                                        ...
                                                        <div className="form-group col-md-4 ">
                                                            <label htmlFor="dealerCode" className="font-weight-normal">Dealer Code <span className="text-danger">*</span></label>
